...
(function () {
  ...
  var tournaments = [
    ...
    },
    {
      ...
      losers: {
        rounds: ['Round of 16 survivor', 'Quarterfinal', 'Semifinal survivor', 'Semifinal', 'Final survivor', 'Final'],
        matches: [
          [
      ...
      results: [
        ...
        { round: 'Final survivor \u00B7 Jul 3', rows: ['Sara Nasser 1\u20130 Mohammad Al-Khatib'] },
      ...
      schedule: [
        ...
        { when: 'Tue Jun 30 \u00B7 6:00 PM', what: 'Semifinal survivor', where: 'Hall A', done: true },
        { when: 'Fri Jul 3 \u00B7 7:00 PM', what: 'W-Final \u00B7 Final survivor', where: 'Hall A', done: true },
